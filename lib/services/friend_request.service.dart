...
class FriendRequestService {
  ...
  /*
   * Service Implementation for deleting friend requests.
   * @param deleteFriendRequestDto DTO Implementation for deleting friend requests.
   */
  Future<void> deleteFriendRequest(
    ...
    try {
      ...
      // Preparing body for the request.
      String body = json.encode(deleteFriendRequestDto.toJson());
      ...
      // Deleting request from the server
      http.Response response = await http
          .delete(
            url,
            headers: headers,
